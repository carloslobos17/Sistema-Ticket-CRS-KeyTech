            ...
            <div className="mx-auto max-w-7xl p-6">
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-100">Gestiona los miembros de tu equipo, sus roles y departamentos.</p>
                    </div>
                            ...
                            {users.map((user) => (
                                <tr key={user.id} className="transition-colors hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div className="mt-0.5 text-xs text-gray-500">Tel: {user.phone_number}</div>
                                    </td>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                            <span className={`inline-flex items-center rounded-full border px-2.5 py-1 text-xs font-medium ${
                                                ...
                                                <span className={`mr-1.5 h-1.5 w-1.5 rounded-full ${
                                                    user.is_active === 1 ? 'bg-emerald-500' : 'bg-red-500'
                                                }`} />
                                                {user.is_active === 1 ? 'Activo' : 'Inactivo'}
                                            </span>
                                    </td>
                                    <td className="space-x-4 px-6 py-4 text-right font-medium whitespace-nowrap">
                                        <button className="text-blue-600 transition-colors hover:text-blue-900">Editar</button>
                                        <button className="text-red-600 transition-colors hover:text-red-900">Eliminar</button>
                                    </td>
                                </tr>
                            ))}
                            </tbody>
